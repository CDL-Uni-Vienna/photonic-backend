...
class TLPM:
    ...
    def __init__(self):
        if sizeof(c_voidp) == 4:
            self.dll = cdll.LoadLibrary(r"C:\Users\zilkf\Documents\DEV\thorlabs_powermeter_motors\ThorLabs\libs\TLPM_32.dll")
        else:
            self.dll = cdll.LoadLibrary(r"C:\Users\zilkf\Documents\DEV\thorlabs_powermeter_motors\ThorLabs\libs\TLPM_64.dll")
